...
### 🎓 B.Tech Computer Science @ BIT Mesra (CGPA: 9.14)
### 💻 Associate Software Developer @ Oracle | Research Fellow | ICPC'24 AIR 86
### 🛠️ MERN | Spring Boot | Computer Vision | Blockchain | DevOps

---

### 🏆 Key Achievements
- **ICPC 2024:** All India Rank **86**.
- **Codeforces:** **Expert** (Max Rating: 1617).
- **Hackathon Winner:** Pantheon’23, IEEE Megaproject’23.
- **Amazon AI For Bharat:** Finalist for KisaanVaani.
...
<p align="left">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=java,js,react,nextjs,nodejs,express,mongodb,cpp,py,docker,kubernetes,aws,gcp,git,github,vscode,postman,tailwind" />
  </a>
</p>
...
### 💼 Experience & Research
- **Oracle** | Associate Software Developer (Post Quantum Cryptography & API Security)
- **Ulster University, UK** | Research Fellow (Computer Vision & YOLO v11)
- **Fleeter** | SDE Intern (Maps, Payments, GPS & AWS Optimization)
- **Texas Instruments** | SDE Intern (Spring Boot & SQL Optimization)
- **Senquire** | Research Intern (Human Body Key-point & Vehicle Speed Estimation)

---

### 🚀 Highlight Projects
- **Dection:** 100% decentralized voting application (Ethereum, Hardhat, Next.js).
- **GCC Optimization:** C source code optimization using Control Flow Graphs.
- **KisaanVaani:** AI chatbot for farmers (Finalist, Amazon AI For Bharat).
